...
# how many number combination
n = int(sys.argv[3])
# user enter the number combination
number_list = list(sys.argv[4:])
# map each string into an integer
number_list = map(int, number_list)
# convert map output to list of integer
