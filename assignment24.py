...
def sticker():
    ...
    face_cascade = cv.CascadeClassifier("/Users/azureennaja/Desktop/Perantis/cv-master/cv-master new/samples/data/haarcascade_frontalface_default.xml")
    nose_cascade = cv.CascadeClassifier("/Users/azureennaja/Desktop/Perantis/cv-master/cv-master new/samples/data/haarcascade_mcs_nose.xml")
    eyepair_cascade = cv.CascadeClassifier("/Users/azureennaja/Desktop/Perantis/cv-master/cv-master new/samples/data/haarcascade_mcs_eyepair_big.xml")
    ...
    img_moustache = cv.imread('/Users/azureennaja/Desktop/Perantis/cv-master/cv-master new/advance/assets/mm1.png', -1)
    img_glasses = cv.imread('/Users/azureennaja/Desktop/Perantis/cv-master/cv-master new/advance/assets/pinkk.png', -1)

    # Create the mask for the moustache:
    img_moustache_mask = img_moustache[:, :, -1]
    img_glasses_mask = img_glasses[:, :, -1]
    ...
    while True:
        ...
        cv.imshow('Sticker glasses and moustache', frame)
